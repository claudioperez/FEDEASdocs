%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%TEST 1 - CreateMesh: Variable offset at each node 
% specified by OFF matrix.
%
% CreateMesh implemented in lines 37-42
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
CleanStart
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
% Create mesh
OFF = [1.5    1.5; % Offset matrix; size of CONN with 0's at nodes to skip
       0.0    0.0;
       1.5    0.0;
       1.5    1.5;
       0.0    1.5;];
