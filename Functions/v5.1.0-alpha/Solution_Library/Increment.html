...
<html>
<head>
  <title>Description of Increment</title>
  <meta name="keywords" content="Increment">
  <meta name="description" content="INCREMENT load incrementation and state advance under static conditions">
...
<body>
<a name="_top"></a>
<div><a href="../FEDEASLab.html">Home</a> &gt;  <a href="FEDEASLab.html">Solution_Library</a> &gt; Increment.m</div>
...
<div class="box"><strong>function [State,SolStrat] = Increment(Model,ElemData,Loading,State,SolStrat) </strong></div>
...
<li><a href="LoadFactorControl.html" class="code" title="function SolStrat = LoadFactorControl (action,SolStrat,detKf,Pref,Ut,DUr)">LoadFactorControl</a>	LOADFACTORCONTROL determine load factor increment under load control strategy</li><li><a href="LoadFactorIncrement.html" class="code" title="function Dlam = LoadFactorIncrement (History,Time,Deltat)">LoadFactorIncrement</a>	LOADFACTORINCREMENT load factor increment(s) for given load histories</li><li><a href="StateDetermination.html" class="code" title="function State = StateDetermination (StifUpdt,Model,ElemData,State)">StateDetermination</a>	STATEDETERMINATION structure state determination under static conditions</li></ul>
